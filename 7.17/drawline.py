...
def drawlines():
    ...
    cv2.drawMarker(img, (50,350),(0,255,255),cv2.MARKER_CROSS)
    cv2.drawMarker(img, (100,350),(230,150,255),cv2.MARKER_TILTED_CROSS)
    cv2.drawMarker(img, (150,350),(255,0,255),cv2.MARKER_DIAMOND)
    cv2.drawMarker(img, (200,350),(255,0,255),cv2.MARKER_SQUARE)
    cv2.drawMarker(img, (250,350),(255,0,255),cv2.MARKER_TRIANGLE_UP)
    cv2.drawMarker(img, (300,350),(255,0,255),cv2.MARKER_TRIANGLE_DOWN)
